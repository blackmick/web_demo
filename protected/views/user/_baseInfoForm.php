...
<div class="form">
    ...
    <div class="row">
        ...
        <?php echo $form->passwordField($model,'last_name',array('size'=>60,'maxlength'=>128)); ?>
        <?php echo $form->error($model,'last_name'); ?>
    </div>

    <div class="row">
        <?php echo $form->labelEx($model,'mid_name'); ?>
        <?php echo $form->textField($model,'mid_name',array('size'=>60,'maxlength'=>128)); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model,'location',array('size'=>60,'maxlength'=>512)); ?>
